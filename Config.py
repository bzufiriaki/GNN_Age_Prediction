...
class GeneralConfig(object):
    dataset = r"..\Cam-CAN-Dataset\Brainnetome"
    ...
    connectivity_matrices_con_mask = "conn_mats_con_mask"
    connectivity_matrices_fc_mask = "conn_mats_fun_mask"
    connectivity_matrices_sc_mask = "conn_mats_gm"
...
class TrainConfig(object):
    ...
    output = r'..\output'  # folder to save output models
    threshold = 1.0
    edge_attention = True
